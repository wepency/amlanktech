...
@push('scripts')
    <script>
        ...
        AddReceiptsBtn.on('click', function (e) {
            ...
            $.get('{{dashboard_route('income-receipts.create')}}').done(function (data) {
        ...
        $('body').on('click', EditReceiptsBtn, function (e) {
            ...
            let url = '{{dashboard_route('income-receipts.edit', ':id')}}';
        ...
        let table = $('#data-table').DataTable({
            ...
            stateSave: true,
            ajax: {
                url: "{{ dashboard_route('income-receipts.index') }}",
                data: function (d) {
                    d.type = $('#units-results li a.active').data('type')
                }
            },
            language: {
